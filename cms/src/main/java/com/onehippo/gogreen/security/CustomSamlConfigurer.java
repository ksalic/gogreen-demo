 ...
 * <p>
 * Custom SamlConfigurer, for the sole purpose of injecting a SAMLContextProvider into the MetadataDisplayFilter,
 * to prevent a nullpointer beeing thrown when accessing /saml/metadata due to the context not beeing injected by Spring
 * <p>
 * see nl.bzk.security.CustomSamlConfigurer#metadataDisplayFilter(org.springframework.security.saml.context.SAMLContextProvider)
 */
public class CustomSamlConfigurer extends SecurityConfigurerAdapter<DefaultSecurityFilterChain, HttpSecurity> {
    ...
    private CustomSamlConfigurer(final String hostname, final String protocol) {
    ...
    public static CustomSamlConfigurer saml(String hostname, String protocol) {
        return new CustomSamlConfigurer(hostname, protocol);
    }
    ...
    public CustomSamlConfigurer forcePrincipalAsString() {
        this.forcePrincipalAsString = true;
        return this;
    }

    public CustomSamlConfigurer webSSOProfileConsumer(WebSSOProfileConsumerImpl webSSOProfileConsumer) {
    ...
    private String entityBaseURL() {
        String entityBaseURL = hostname + "/" + serviceProvider.basePath;
    ...
    private CachingMetadataManager cachingMetadataManager() {
        ...
        try {
            ...
            throw new RuntimeException("Error creating CachingMetadataManager", e);
        }
    ...
    public class IdentityProvider {
        ...
        private FilesystemMetadataProvider fileSystemMetadataProvider() {
            ...
            try {
                ...
                throw new RuntimeException("Error creating FIelsystemMetadataProvider", e);
            }
