        ...
        <ul class="portfolio-filter">
            <c:choose>
              <c:when test="${activeFacNavBean.name eq 'facetedproducts'}">
                <li><a class="portfolio-selected" href="<hst:link siteMapItemRefId="products" navigationStateful="true"/>">All</a></li>
              </c:when>
              <c:otherwise>
                <li><a href="<hst:link siteMapItemRefId="products" navigationStateful="true"/>">All</a></li>
              </c:otherwise>
            </c:choose>
