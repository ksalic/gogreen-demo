...
public class ProductDetail extends BaseComponent {
    ...
    public void doBeforeRender(HstRequest request, HstResponse response) {
        ...
        Product document = (Product) ctx.getContentBean();
        ...
        if (reviewsFolder == null) {
            ...
            try {
                ...
                final HstQuery incomingBeansQuery = ContentBeanUtils.createIncomingBeansQuery(document, reviewsFolder, 4, Review.class, false);
    ...
    public void doAction(HstRequest request, HstResponse response) {
        ...
        final HstRequestContext ctx = request.getRequestContext();
        HippoBean reviewFor = ctx.getContentBean();
        ...
        Product product = (Product) request.getRequestContext().getContentBean();
    ...
    public void doBeforeServeResource(HstRequest request, HstResponse response) throws HstComponentException {
        ...
        if (saveDocument || requestPublication) {
            final HstRequestContext ctx = request.getRequestContext();
            String documentPath = ctx.getContentBean().getPath();
            Session persistableSession = null;
            ...
            try {
                ...
                //persistableSession = getPersistableSession(request);
                persistableSession = ctx.getSession();
