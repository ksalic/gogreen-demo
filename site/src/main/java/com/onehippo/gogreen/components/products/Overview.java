...
public class Overview extends BaseComponent {
    ...
    public void doBeforeRender(HstRequest request, HstResponse response) {
        ...
        OverviewParamInfo paramInfo = getComponentParametersInfo(request);
        ...
        try {
            HstQuery hstQuery = ctx.getQueryManager().createQuery(ctx.getSiteContentBaseBean(), Product.class);
            ...
            if (!(currentBean instanceof HippoFacetChildNavigationBean || currentBean instanceof HippoFacetNavigation)) {
                ...
                final HippoFacetNavigationBean facNavBean = ContentBeanUtils.getFacetNavigationBean(hstQuery);
