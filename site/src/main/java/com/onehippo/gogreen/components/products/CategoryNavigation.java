...
public class CategoryNavigation extends BaseComponent {

    public static final Logger log = LoggerFactory.getLogger(CategoryNavigation.class);
    ...
    public void doBeforeRender(HstRequest request, HstResponse response) {
        ...
        HippoFacetNavigationBean activeFacNavBean = null;
        ...
        activeFacNavBean = ContentBeanUtils.getFacetNavigationBean(resolvedContentPath, query);
        ...
        request.setAttribute("activeFacNavBean", activeFacNavBean);
    }
}
