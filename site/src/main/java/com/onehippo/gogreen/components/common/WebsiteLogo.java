...
import com.onehippo.gogreen.channels.WebsiteInfo;
...
public class WebsiteLogo extends BaseComponent {

    private final Logger log = LoggerFactory.getLogger(WebsiteLogo.class);
